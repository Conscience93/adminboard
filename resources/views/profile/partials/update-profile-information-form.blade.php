<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" >
        ...
        <div>
            ...
            <input type="file" id="photo" name="photo" class="mt-1 mb-1 block w-full" />
            <img id="showPhoto" class="mt-2 wd-80 rounded-circle" src="{{ (!empty($user->photo)) ? url('upload/user_images/'.$user->photo) : url('upload/no_image.jpg') }}" alt="profile">
        </div>
